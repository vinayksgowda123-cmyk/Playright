        ...
        - generic [ref=e357]:
          ...
          - list "Company logos" [ref=e360]:
            - listitem "ReqRes is used by developers at Coca-Cola (opens in new tab)" [ref=e361] [cursor=pointer]:
              - img "Coca-Cola"
            - listitem "ReqRes is used by developers at Siemens (opens in new tab)" [ref=e362] [cursor=pointer]:
              - img "Siemens"
            - listitem "ReqRes is used by developers at Confluent (opens in new tab)" [ref=e363] [cursor=pointer]:
              - img "Confluent"
            - listitem "ReqRes is used by developers at Cisco (opens in new tab)" [ref=e364] [cursor=pointer]:
              - img "Cisco"
            - listitem "ReqRes is used by developers at EPAM (opens in new tab)" [ref=e365] [cursor=pointer]:
              - img "EPAM"
            ...
            - listitem "ReqRes is used by developers at Deloitte (opens in new tab)" [ref=e369] [cursor=pointer]:
              - img "Deloitte"
            - listitem "ReqRes is used by developers at Vodafone (opens in new tab)" [ref=e370] [cursor=pointer]:
              - img "Vodafone"
            - listitem "ReqRes is used by developers at IBM (opens in new tab)" [ref=e371] [cursor=pointer]:
              - img "IBM"
            - listitem "ReqRes is used by developers at Mastercard (opens in new tab)" [ref=e372] [cursor=pointer]:
              - img "Mastercard"
            - listitem "ReqRes is used by developers at Sainsbury's (opens in new tab)" [ref=e373] [cursor=pointer]:
              - img "Sainsbury's"
            - listitem "ReqRes is used by developers at Adobe (opens in new tab)" [ref=e374] [cursor=pointer]:
              - img "Adobe"
            - listitem "ReqRes is used by developers at Adidas (opens in new tab)" [ref=e375] [cursor=pointer]:
              - img "Adidas"
            ...
            - listitem "ReqRes is used by developers at Cognizant (opens in new tab)" [ref=e377] [cursor=pointer]:
              - img "Cognizant"
            - listitem "ReqRes is used by developers at Microsoft (opens in new tab)" [ref=e378] [cursor=pointer]:
              - img "Microsoft"
            - listitem "ReqRes is used by developers at Salesforce (opens in new tab)" [ref=e379] [cursor=pointer]:
              - img "Salesforce"
            - listitem "ReqRes is used by developers at Builder.io (opens in new tab)" [ref=e380] [cursor=pointer]:
              - img "Builder.io"
